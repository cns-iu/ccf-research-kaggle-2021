...
def train(config, dataset, fold, log_folder=None):
    ...
    #############################transfer learning##########################
    cp_folder = r"C:\Users\soodn\Downloads\Naveksha\Kaggle HuBMAP\Scripts\4. DeepLive\hubmap-cp\b1_last\b1_last/"
...
#     config = Config(**config)
    ...
    model = load_model_weights(model, weights[0]).to(device)
    model.eval()
