...
# Input - test images, test.csv  <br>
# Output - submission.csv <br>
# 
# <b>How to use?</b><br> 
...
# Delete model.pth file unnecessarily created during training.
try:
...
class CONFIG():
    ...
    # data paths
    data_path = r'../../../Colonic_crypt_dataset/'
...
df_sample = pd.read_csv(cfg.data_path+'test.csv', index_col = "id")
